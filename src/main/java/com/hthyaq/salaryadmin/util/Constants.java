...
public class Constants {
    ...
    //excel文件的目录
    public static String EXCEL_PAHT = "D:" + FILE_SEPARATOR + "salaryFile" + FILE_SEPARATOR + "excel" + FILE_SEPARATOR;
    //ureport文件的目录
    public static final String UREPORT_PAHT = "D:" + FILE_SEPARATOR + "salaryFile" + FILE_SEPARATOR + "ureportfiles";
    //临时文件的目录
    public static final String TMP_PAHT = "D:" + FILE_SEPARATOR + "salaryFile" + FILE_SEPARATOR + "tmp";
